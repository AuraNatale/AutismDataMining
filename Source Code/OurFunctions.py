...
numeric_columns, categorical_columns = select_columns(our_dataset_inuse)'''
...
def plot_missing_values(columns_with_nan_sorted, numeric_columns):
...
def plot_features_by_presence(columns_by_presence, numeric_columns):
    # Assegna colori alle colonne
